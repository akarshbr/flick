...
import 'package:flick/presentation/bottom_navigation_screen/view/bottom_navigation_screen.dart';
import 'package:flutter/material.dart';
import 'package:font_awesome_flutter/font_awesome_flutter.dart';
import 'package:provider/provider.dart';

import '../../../core/dummy_data/backgroundImage.dart';
import '../../../core/dummy_data/langauges.dart';
      ...
      body: Container(
        ...
        child: CustomScrollView(
          slivers: [
            ...
            Consumer<LanguageController>(builder: (context, languageProvider, child) {
              return SliverGrid(
